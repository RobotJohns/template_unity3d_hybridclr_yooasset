...
internal class FsmInitializePackage : IStateNode
{
    ...
    void IStateNode.OnEnter()
    {
        ...
        PatchManager.Instance.StartCoroutine(InitPackage());
    }
    ...
    private IEnumerator InitPackage()
    {
        ...
        {
            string defaultHostServer = HostServerConfig.GetConfig();
            string fallbackHostServer = HostServerConfig.GetConfig();
